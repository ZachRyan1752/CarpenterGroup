...
Folder = "D:\Microscope Data\ZDRPI_XYZ_Characterization\ExtractedData/FFTs/"
...
for Items in DoubleGroupedArray:
    ...
    for SubItem1 in Items:
        ...
        for SubItem2 in Items[::-1]:
            if SubItem1 != SubItem2 and SubItem1[0:7] == SubItem2[0:7]:
                ...
                XAxis = CSVData1['Frequency X']
                YAxis = CSVData1['Frequency Y']    

                XData1 = CSVData1['X_FFT']
                YData1 = CSVData1['Y_FFT']

                XData2 = CSVData2['X_FFT']
                YData2 = CSVData2['Y_FFT']
        ...
        if SubItem1 not in SkipList:
            ...
            XAxis = CSVData['Frequency X']
            YAxis = CSVData['Frequency Y']

            XData = CSVData['X_FFT'] + Iterator * Mult
            YData = CSVData['Y_FFT'] + Iterator * Mult
    ...
    if BigIterator == 0:
        ...
        for elements in YDataArray[0]:
            YDataArray[0][Index] -= YInitial[0][Index] - Index * Mult2
            YDataArray[1][Index] -= YInitial[1][Index] - Index * Mult2
